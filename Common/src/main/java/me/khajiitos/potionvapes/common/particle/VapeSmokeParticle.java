...
public class VapeSmokeParticle extends TextureSheetParticle {
    protected VapeSmokeParticle(ClientLevel level, double x, double y, double z, double velocityX, double velocityY, double velocityZ, int color) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double velocityX, double velocityY, double velocityZ, int color) {
            VapeSmokeParticle $$8 = new VapeSmokeParticle(level, x, y, z, velocityX, velocityY, velocityZ, color);
